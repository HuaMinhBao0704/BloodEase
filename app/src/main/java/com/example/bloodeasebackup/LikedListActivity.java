...
public class LikedListActivity extends AppCompatActivity {
    ...
    private ArrayList<View> hospitalsToDisplay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hospitalsToDisplay = new ArrayList<>();

        String selectedDate = getIntent().getStringExtra("selectedDate");

        inputDate.setText(selectedDate);

        loadHospitalsForDate(selectedDate);
    ...
    private void loadHospitalsForDate(String selectedDate) {
        containerLayout.removeAllViews();
        hospitalsToDisplay.clear();
